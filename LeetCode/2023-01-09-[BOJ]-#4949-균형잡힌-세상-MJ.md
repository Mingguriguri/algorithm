...
while True:
    ...
    if temp == True and not stack:
        ...
        print('no')
```
![%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7_2023-01-09_14-45-14](https://user-images.githubusercontent.com/101111603/211248253-38f588d0-6269-4020-ba25-e937f4391944.png)
